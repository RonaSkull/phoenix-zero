(function () {
  ...
  async function runOne(hostEl) {
    if (!hostEl || hostEl.__phoenixZeroLiveMountedV1) return;
    hostEl.__phoenixZeroLiveMountedV1 = true;
    ...
    var endpoint =
      apiBase.replace(/\/+$/g, '') + '/api/auth-proxy?type=live&jobId=' + encodeURIComponent(jobId);
